...
namespace DataAccessMsSqlServerProvider.Migrations
{
    ...
    [Migration("20170303082552_AddParentIDsNameAndGUID")]
    partial class AddParentIDsNameAndGUID
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("DomainModel.Model.ProjectTreeNode", b =>
                {
                    b.Property<long>("ProjectTreeNodeID")
                        .ValueGeneratedOnAdd();

                    b.Property<long>("ParentProjectTreeNodeID");

                    b.HasKey("ProjectTreeNodeID");

                    b.ToTable("ProjectTree");
                });
